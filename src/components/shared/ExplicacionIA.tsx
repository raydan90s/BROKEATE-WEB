 ...
 *
 * El texto no se reescribe ni se acorta con otras palabras: lo que se ve es literal, porque
 * el guardarraíl validó **ese** texto y no una paráfrasis nuestra. Eso importa doble en la
    ...
    <View className="gap-3 rounded-2xl bg-brandAlpha-primarySoft p-5">
      ...
      {hayMas ? (
        <Touchable
          ...
          className="w-fit flex-row items-center gap-1 self-start"
        >
